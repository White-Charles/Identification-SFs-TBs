...
Figure.3 The output picture after the user starts the [main3.m](/clustering algorithm/main3.m), the coordinates are cursor click position. (a) Defect structural clustering analysis (b) The TB is selected (c) The SF is selected (d) The HCP phase is selected.
